---
name: "ponytail"
description: "Applies the Ponytail lazy-senior-dev coding philosophy: minimize code by preferring reuse, stdlib, native features, and one-liners while keeping safety guards. Invoke automatically when the user asks to write, edit, refactor, or review code."
---
...
If the user explicitly asks for it, you may perform these actions:

- `ponytail-review`: Review the current diff for over-engineering and propose a delete-list.
